        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-5xl font-bold text-red-500 mb-6">{car.price}</p>
              ...
              <div className="flex gap-4 mb-8 border-b border-gray-800">
                {(['overview', 'features', 'contact'] as const).map((tab) => (
                  ...
                  >
                    {tab}
                    {activeTab === tab && (
                      <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-red-600 to-orange-500"></div>
                    )}
                  </button>
                ))}
              </div>
              ...
              <div className="space-y-6">
                {activeTab === 'overview' && (
                  <div>
                    <h3 className="text-2xl font-bold mb-4">Vehicle Overview</h3>
                    <p className="text-gray-400 mb-6">{car.description}</p>
                    
                    <div className="grid grid-cols-2 gap-4 bg-gray-900 p-6 rounded-xl">
                      ...
                      <div className="border-b border-gray-800 pb-3">
                        ...
                        <p className="text-xl font-semibold">{car.mileage}</p>
                      </div>
                      <div className="border-b border-gray-800 pb-3">
                ...
                {activeTab === 'features' && (
                  <div>
                    <h3 className="text-2xl font-bold mb-4">Features & Options</h3>
                    <div className="space-y-3">
                      {car.features?.map((feature, idx) => (
                        <div key={idx} className="flex items-center gap-3 bg-gray-900 p-4 rounded-lg">
                ...
                {activeTab === 'contact' && (
                  <div>
                    ...
                    <p className="text-gray-400 mb-6">
                      Interested in this vehicle? Get in touch with our sales team.
                    </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <button className="w-full flex items-center justify-center gap-4 bg-gradient-to-r from-red-600 to-orange-500 p-4 rounded-lg font-semibold hover:shadow-lg hover:shadow-red-500/50 transition-all">
